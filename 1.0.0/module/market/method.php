...
{   
  ...
  function index(){
	...
	/* 分类改变 */
			$moretypelist = $this->mysql->getarr("select* from ".Mysite::$app->config['tablepre']."appadv where type=2 and activity = 'market' and param != 'lifehelp'  and (   cityid='".$this->CITY_ID."'  or  cityid = 0 ) order by orderid  asc");
