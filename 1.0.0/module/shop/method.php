...
class method extends baseclass
{
    ...
    {  	//菜品详情
        ...
        $pingjiashuliang  = $this->mysql->counts("select * from  ".Mysite::$app->config['tablepre']."comment where  is_show = 0 and  goodsid=".$id." and shopid=".$shopid." order by addtime desc");
