...
class method extends adminbaseclass
{
    ...
    public function shopactivetime()
    {
        ...
        if ($mysetclosetime>7486) {
            $this->message("最大为7486天");
        }
        if ($mysetclosetime<0) {
            $this->message("最小为0天");
        }
    ...
    */
    ...
    public function addshopcateadv()
    {
        $id = intval(IReq::get('id'));
    ...
    public function saveshopcateadv()
    {
        $id = IReq::get('uid');
        $data['addtime'] = time();
    ...
    public function delshopcateadv()
    {
