...
<?php if ($GLOBALS['cfg']['AllowArbitraryServer']) { ?>
        <div class="item">
            ...
            <input type="text" name="pma_servername" id="input_servername" value="127.0.0.1" size="24" class="textfield" title="<?php echo __('You can enter hostname/IP address and port separated by space.'); ?>" />
        </div>
<?php } ?>
        <div class="item">
