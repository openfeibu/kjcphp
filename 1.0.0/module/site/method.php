...
<body style="height:100%;width:100%;margin:0px;">
   <div style="max-width:400px;margin:0px;margin:0px auto;min-height:300px;"> '.$tempcontent.'    </div>
    ...
    public function postmsgbypay()
    {
        ...
        $tj = $this->mysql->select_one("select daycode,id from ".Mysite::$app->config['tablepre']."order where shopid='".$orderinfo['shopid']."' and addtime > ".$minitime." AND paystatus = 1 order by id desc limit 0,1000");
