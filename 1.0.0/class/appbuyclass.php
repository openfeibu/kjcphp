...
class appbuyclass
{
	...
	function __construct(){ 	  
	  	...
	  	$this->otherlink = '';
		$this->noticetype = 1;
		$this->xmbao = Mysite::$app->config['xmbao2'];//小米包名
		$this->xmtitle =  Mysite::$app->config['xmtitle2'];//小米推送标题
		$this->miuiKey =  Mysite::$app->config['miuiKey2'];;//小米的key值
