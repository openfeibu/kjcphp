...
function modifypwd()
{
 	var showcontent = '<form method="post" name="form1" action="'+siteurl+'/index.php?ctrl=areaadminpage&action=member&module=adminmodify&datatype=json" onsubmit="return subform(\'\',this);">	<div class="popLayCon "><div class="popLayBox"><div class="popLayOrdCon"><div class="popLayOrdPri"><ul><li><span>旧密码</span><input type="password" name="oldpwd" value="" ></li><li><span>新密码</span><input type="password" type="password" name="pwd"  ></li></ul></div><div class="popLayOrdBut"><input type="submit" value="确认提交"></div></div></div></div></form>';
	art.dialog({
    id: 'KDf435',
    title: '修改账号密码',
    content: showcontent
