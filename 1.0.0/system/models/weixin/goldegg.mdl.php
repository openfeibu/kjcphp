...
{   
    ...
    protected $_pk = 'id';
    protected $_cols = 'id,predict_num,shop_id,keyword,photo,title,use_tips,stime,ltime,info,aginfo,end_tips,end_photo,fist,fistnums,fistlucknums,second,secondnums,secondlucknums,third,thirdnums,thirdlucknums,joinnum,max_num,parssword,four,fournums,fourlucknums,five,fivenums,fivelucknums,six,sixnums,sixlucknums,daynums,member_condtion,dateline,follower_condtion';
