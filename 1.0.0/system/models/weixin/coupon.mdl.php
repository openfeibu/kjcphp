...
{   
    ...
    protected $_cols = 'coupon_id,shop_id,type,member_condtion,keyword,title,intro,photo,stime,ltime,use_tips,end_tips,end_photo,num,max_count,down_count,use_count,views,follower_condtion,clientip,dateline';
