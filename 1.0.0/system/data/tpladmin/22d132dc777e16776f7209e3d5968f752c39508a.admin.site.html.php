...
<?php /*%%SmartyHeaderCode:82345a1b627f653cd6-91743422%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '82345a1b627f653cd6-91743422',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5a1b627f6d0cf5_90643359',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a1b627f6d0cf5_90643359')) {function content_5a1b627f6d0cf5_90643359($_smarty_tpl) {?><?php if (!is_callable('smarty_function_widget')) include 'D:\\WWW\\48ym\\system\\plugins/smarty\\function.widget.php';
...
<tr><th class="w-100">开启订单审核：</th>
	<td>
		<label><input type="radio" name="config[is_status]" <?php if ($_smarty_tpl->tpl_vars['config']->value['is_status']){?>checked="checked"<?php }?> value="1"/>开启</label>&nbsp;&nbsp;
		<label><input type="radio" name="config[is_status]" <?php if (empty($_smarty_tpl->tpl_vars['config']->value['is_status'])){?>checked="checked"<?php }?> value="0"/>关闭</label>
		<span class="tip-comment">建议给客户测试订单时再关闭。</span>
	</td>
</tr>
