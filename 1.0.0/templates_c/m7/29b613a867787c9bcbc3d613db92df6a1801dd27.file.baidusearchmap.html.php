<?php /* Smarty version Smarty-3.1.10, created on 2018-01-31 23:11:02
         compiled from "D:\UPUPW_K2.1\htdocs\wmr87\templates\m7\site\baidusearchmap.html" */ ?>
<?php /*%%SmartyHeaderCode:179945a71dc8640ea39-12476648%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '29b613a867787c9bcbc3d613db92df6a1801dd27' => 
    array (
      0 => 'D:\\UPUPW_K2.1\\htdocs\\wmr87\\templates\\m7\\site\\baidusearchmap.html',
      1 => 1500876528,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '179945a71dc8640ea39-12476648',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5a71dc870a69e5_20371222',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a71dc870a69e5_20371222')) {function content_5a71dc870a69e5_20371222($_smarty_tpl) {?><!DOCTYPE HTML>
<html>
<head>
...
<?php if ($_smarty_tpl->tpl_vars['webcaption']->value!=''){?><?php echo $_smarty_tpl->tpl_vars['webcaption']->value;?>
<?php }else{ ?>/upload/images/guideBg.png<?php }?>" style="height:54px;width:550px"/>
	  </div>
...
<div style="height:220px;   background:#fff; ">
	<ul style="width:400px; margin: 70px auto 0px;">
		<li style="float:left;">
			<img src="<?php echo $_smarty_tpl->tpl_vars['siteurl']->value;?>
<?php if ($_smarty_tpl->tpl_vars['appewm']->value!=''){?><?php echo $_smarty_tpl->tpl_vars['appewm']->value;?>
<?php }else{ ?>/upload/app/m6app_ewm.png<?php }?>" alt="手机APP下载" width="142" height="142"  /><br><br>
			<span style="margin-left:30px;font-size:14px">手机APP下载</span>
		</li>
		<li style="float:right; border-left:1px solid #e6e6e6; padding-left:55px; ">
			<img src="<?php echo $_smarty_tpl->tpl_vars['siteurl']->value;?>
<?php if ($_smarty_tpl->tpl_vars['wxewm']->value!=''){?><?php echo $_smarty_tpl->tpl_vars['wxewm']->value;?>
<?php }else{ ?>/upload/app/m6wx_ewm.png<?php }?>" alt="微信端扫描二维码" width="142" height="142"  /><br><br>
