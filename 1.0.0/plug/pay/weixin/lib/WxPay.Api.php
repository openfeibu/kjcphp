<?php
require_once $weixindir."lib/WxPay.Exception.php";
require_once $weixindir."lib/WxPay.Config.php";
require_once $weixindir."lib/WxPay.Data.php";
...
class WxPayApi
{
	...
	private static function postXmlCurl($xml, $url, $useCert = false, $second = 30)
	{
		...
		//var_dump(hopedir.WxPayConfig::SSLCERT_PATH);exit;
		...
		if($useCert == true){
			...
			curl_setopt($ch,CURLOPT_SSLCERT, hopedir.WxPayConfig::SSLCERT_PATH);
			curl_setopt($ch,CURLOPT_SSLKEYTYPE,'PEM');
			curl_setopt($ch,CURLOPT_SSLKEY, hopedir.WxPayConfig::SSLKEY_PATH);
		}
		//post提交方式
