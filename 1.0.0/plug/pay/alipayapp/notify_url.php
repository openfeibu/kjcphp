    		...
    		if($backinfog['status'] == 0){
              ...
              $dotime = time(); 
				$checkcost = $memberinfo['cost']+$backinfog['cost'];
					 ...
					 mysql_query("INSERT INTO `".$cfg['tablepre']."memcostlog`(`uid`,`username`,`cost`,`bdtype`,`bdcost`,`curcost`,`bdliyou`,`czuid`,`czusername`,`addtime`) VALUES('".$memberinfo['uid']."','".$memberinfo['username']."','".$memberinfo['cost']."',1,'".$backinfog['cost']."','".$checkcost."','微信充值','".$memberinfo['uid']."','".$memberinfo['username']."','".$dotime."');");
