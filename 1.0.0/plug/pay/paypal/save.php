...
$setting .=" \$alipay_config['clientId']		= '".IReq::get('clientId')."';\r\n";
$setting .=" \$alipay_config['secret']		= '".IReq::get('secret')."';\r\n";
$setting .=" \$alipay_config['is_sanbox']		= '".IReq::get('is_sanbox')."';\r\n"; 
...
$savedata['clientId']=IReq::get('clientId');
$savedata['secret']=IReq::get('secret'); 
$savedata['is_sanbox']=IReq::get('is_sanbox'); 
