...
<MsgType><![CDATA[transfer_customer_service]]></MsgType>
	...
	public function fbAdminReply(){
		$showcontent = '';
		$showcontent .= '您好，欢迎测试筷叫餐网上订餐网站系统。';
		$showcontent .="\n";
		$showcontent .= '系统总后台';
		$showcontent .="\n";
		$showcontent .= '账号：admin  密码：ghfb';
		$showcontent .="\n";
		$showcontent .= '商家后台';
		$showcontent .="\n";
		$showcontent .= '账号：shangjia 密码：ghfb';
		$showcontent .="\n";
		$showcontent .= '配送端';
		$showcontent .="\n";
		$showcontent .= '账号：peisong 密码：ghfb';
 		return $showcontent;
	}
	function showorder(){
 		global $Mconfig; 
  ...
  function GetDistance($lat1, $lng1, $lat2, $lng2, $len_type = 1, $decimal = 2)
  {
	...
	function event(){ 
		...
		switch($controller){
		   case 'subscribe': //关注
		   	...
		   	//<EventKey><![CDATA[qrscene_sp_1]]></EventKey> 
				$shopid = 0;
	...
	function Mlink($link){
	  ...
	  //	$backinfo =  str_replace(array('"',',','&'),array('-','^','@'),json_encode($link));
