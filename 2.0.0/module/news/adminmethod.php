...
class method extends adminbaseclass
{
    ...
    public function savelifeass()
    {
        ...
        if (empty($id)) {
            ...
            if (empty($data['title'])) {
                $this->message('生活服务标题不能为空！', $link);
            }
            if (empty($data['describe'])) {
                $this->message('生活服务简介不能为空！', $link);
            }

            if (empty($data['phone'])) {
                $this->message('生活服务联系电话不能为空！', $link);
            }

            if (empty($data['content'])) {
                $this->message('生活服务内容不能为空！', $link);
            }
            $this->mysql->insert(Mysite::$app->config['tablepre'].'information', $data);
        } else {
    ...
    public function savehelpcenter()
    {
        ...
        if (empty($id)) {
            ...
            if (empty($data['content'])) {
                $this->message('内容不能为空', $link);
            }
            if (empty($data['title'])) {
                $this->message('标题不能为空', $link);
            }
