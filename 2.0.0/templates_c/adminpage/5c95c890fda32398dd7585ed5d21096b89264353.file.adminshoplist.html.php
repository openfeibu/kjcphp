<?php /* Smarty version Smarty-3.1.10, created on 2018-04-16 22:26:19
         compiled from "C:\UPUPW_K2.1\htdocs\kjc\2.0.0\templates\adminpage\shop\adminshoplist.html" */ ?>
<?php /*%%SmartyHeaderCode:85515ad4b28b4c96d2-81472205%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5c95c890fda32398dd7585ed5d21096b89264353' => 
    array (
      0 => 'C:\\UPUPW_K2.1\\htdocs\\kjc\\2.0.0\\templates\\adminpage\\shop\\adminshoplist.html',
      1 => 1522049843,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '85515ad4b28b4c96d2-81472205',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ad4b28c3d5498_32198295',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ad4b28c3d5498_32198295')) {function content_5ad4b28c3d5498_32198295($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include 'C:\\UPUPW_K2.1\\htdocs\\kjc\\2.0.0\\lib\\Smarty\\libs\\plugins\\modifier.date_format.php';
...
" style="color:#0076cf;" target="_blank">返回网站首页</a></li>-->
 ...
 <div class="right_content">
	<div class="show_content_m">
        ...
        <?php echo smarty_function_load_data(array('assign'=>"stationlist",'table'=>"stationadmininfo",'fileds'=>"*",'limit'=>"1000",'where'=>"stationis_open = 0",'orderby'=>" id desc"),$_smarty_tpl);?>
...
">
 ...
 $_from = $_smarty_tpl->tpl_vars['stationlist']->value['list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
[<font color=red><?php echo $_smarty_tpl->tpl_vars['shoptype']->value[$_smarty_tpl->tpl_vars['items']->value['shoptype']];?>
                        ...
                        <td align="center">
                            <?php echo smarty_function_load_data(array('assign'=>"stationadmininfo",'table'=>"stationadmininfo",'type'=>"one",'where'=>"id='".((string)$_smarty_tpl->tpl_vars['items']->value['stationid'])."'",'fileds'=>"stationname"),$_smarty_tpl);?>

						<?php echo $_smarty_tpl->tpl_vars['stationadmininfo']->value['stationname'];?>
</td>
...
');" href="#">设置</a> </td>
                        <td align="center"><?php if ($_smarty_tpl->tpl_vars['items']->value['is_open']==1){?>是<?php }else{ ?>否<?php }?></td>
                         ...
                         <td align="center" style="width: 120px"><a onclick="setyjin('<?php echo $_smarty_tpl->tpl_vars['items']->value['id'];?>
','<?php echo $_smarty_tpl->tpl_vars['items']->value['shopname'];?>
...
');" href="#">设置</a><?php if ($_smarty_tpl->tpl_vars['items']->value['yjin']=='0'){?>默认<?php echo $_smarty_tpl->tpl_vars['yjin']->value;?>
...
');"> <?php if ($_smarty_tpl->tpl_vars['items']->value['endtime']>0){?>    <?php echo intval(($_smarty_tpl->tpl_vars['items']->value['endtime']-time())/86400);?>
    <?php }else{ ?>设置 <?php }?></a></td>
                        <td align="center">
                        <a onclick="txset('<?php echo $_smarty_tpl->tpl_vars['items']->value['id'];?>
','<?php echo $_smarty_tpl->tpl_vars['items']->value['shopname'];?>
');" href="#">设置</a></td>
                        <?php echo smarty_function_load_data(array('assign'=>"member",'table'=>"member",'type'=>"one",'where'=>"guid='".((string)$_smarty_tpl->tpl_vars['items']->value['uid'])."'",'fileds'=>"uid,username"),$_smarty_tpl);?>


                        <td align="center">
                            <?php if (!empty($_smarty_tpl->tpl_vars['member']->value)){?>
                            <?php echo $_smarty_tpl->tpl_vars['member']->value['username'];?>
 <a onclick="unblind(<?php echo $_smarty_tpl->tpl_vars['items']->value['id'];?>
);" style="cursor: pointer;display: block;" >  解绑</a></td>
                            <?php }?>
                        <td align="center">
                            <a onclick="pscostset('<?php echo $_smarty_tpl->tpl_vars['items']->value['id'];?>
','<?php echo $_smarty_tpl->tpl_vars['items']->value['shopname'];?>
','<?php echo $_smarty_tpl->tpl_vars['items']->value['pscost'];?>
');" href="#"><?php echo $_smarty_tpl->tpl_vars['items']->value['pscost'];?>
</a>
                        </td>
...
{
    if(confirm('确定解绑吗？')){
        url = '<?php echo FUNC_function(array('type'=>'url','link'=>"/adminpage/shop/module/unblindshop/datatype/json"),$_smarty_tpl);?>
';
        $.ajax({
    		type: 'post',
    		async:false,
...
$('#buttonsubpscost').live('click',function(){
	$.post('<?php echo FUNC_function(array('type'=>'url','link'=>"/adminpage/shop/module/savesetshoppscost/datatype/json"),$_smarty_tpl);?>
', $('#subpscost').serialize() ,function (data, textStatus){
			if(data.error == false){
     	  	diasucces('操作成功','');
     	}else{
     		if(data.error == true)
