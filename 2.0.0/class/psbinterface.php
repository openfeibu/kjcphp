...
//        $url = $shopinfo['psblink']."/index.php?c=orderapi&act=get&uid=".$shopinfo['psbapiid']."&do=makeorder&datatype=xml&key=".$shopinfo['psbkey']."&code=".$shopinfo['psbcode'].$pin_str;
    ...
    public function psbunorder($orderid){
        ...
        /*方案1*/
//                          $dodata = array();
//                          $url = $shopinfo['psblink']."/index.php?c=orderapi&act=get&uid=".$shopinfo['psbapiid']."&do=unorder&datatype=json&key=".$shopinfo['psbkey']."&code=".$shopinfo['psbcode']."&outorderid=".$orderid;
//                          $backinfo = $this->vpost($url,$dodata);
//                          $infos = json_decode($backinfo,true);
//                          if($infos['success'] == 200){
//                              return true;
...
//                          }
        ...
        /*方案2*/
//        $url = $shopinfo['psblink']."/index.php?c=orderapi&act=get&uid=".$shopinfo['psbapiid']."&do=unorder&datatype=xml&key=".$shopinfo['psbkey']."&code=".$shopinfo['psbcode']."&outorderid=".$orderid;
        $url = $shopinfo['psblink']."/orderapi/xml/unorder/".$shopinfo['psbversion']."/1&bizid=".$shopinfo['psbaccid']."&key=".$shopinfo['psbkey']."&code=".$shopinfo['psbcode']."&outorderid=".$orderid;
        $callback_info = file_get_contents($url);
        $p = xml_parser_create();
        xml_parse_into_struct($p, $callback_info, $backinfo, $index);
        xml_parser_free($p);
