...
function showEmpty(){
	var emptyhtmls = ''; 
		 emptyhtmls +='   <div id="emptyIng"  style="display: none;text-align: center;  wdith: 80px; height: 90px;  margin-left: -40px; margin-top: -45px;    position: absolute; top: 50%;left: 50%;z-index: 99999999;"> ';
		 emptyhtmls +=' 		<p class="refuImg"><img   src="/upload/images/EmptyLoading.gif"  ></p> ';
