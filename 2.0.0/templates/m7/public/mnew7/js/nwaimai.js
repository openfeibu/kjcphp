	...
	$(".aswmpro span").click(function(){
			...
			if($(this).data("name")=="li"){
				...
				$(".aswm-product-li_on").addClass("aswm-product-li");
					...
					$('.fb_cx_info').css('width','80px');
					$('.fb_cx_info').css('height','80px');
					$('.fb_cx_info').css('top','20px');
					$('.fb_cx_info').css('left','20px');
					$('.fb_cx_info p').css('font-size','14px');
					$('.fb_cx_info p').css('height','25px');
					$('.fb_cx_info p span').css('font-size','24px');
			}else{
				if($(this).data("name")=="lis"){
					$('.btnCart').css('bottom','22px');
					$('.xuanguige').css('bottom','22px');
					$('.newjiacart').css('bottom','22px');
					$('.fb_cx_info').css('width','60px');
					$('.fb_cx_info').css('height','60px');
					$('.fb_cx_info').css('top','5px');
					$('.fb_cx_info').css('left','500px');
					$('.fb_cx_info p').css('font-size','12px');
					$('.fb_cx_info p').css('height','20px');
					$('.fb_cx_info p span').css('font-size','12px');
				}
