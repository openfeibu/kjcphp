...
(function ($) {
	$.hunterTimePicker = function (box, options) {
		...
		function buildHourTpl(){
			...
			hour_html += '<li class="Hunter-delete"><input type="button" class="Hunter-clean-btn" id="Hunter_delete_btn" value="删 除"></li>'
		...
		function deleteBtnEvent(){
			time_wrap.on('click', '#Hunter_delete_btn', function(event){
				event.preventDefault();
				event.stopPropagation();
				var dt = box.val();
				var arr = dt.split(';');
